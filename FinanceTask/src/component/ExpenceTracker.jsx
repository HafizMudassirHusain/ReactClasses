...
function ExpenseDashboard() {
  ...
  return (
    <div className="main dashboard-container flex flex-col lg:flex-row min-h-screen bg-gray-100">
      {/* Sidebar */}
      <aside className="aside w-full lg:w-1/5 p-4 text-white fixed lg:static bottom-0 lg:bottom-auto z-50">
        <h2 className="dashbord text-3xl font-bold mb-6 text-center my-8">Dashboard</h2>
        <nav>
          <ul className='px-5'>
        ...
        <section className="aside p-4 rounded-lg shadow-lg mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded flex-none"
            >
              Submit
            </button>
          </div>
